...
const GameHUD: React.FC<GameHUDProps> = React.memo(({ stats, activeEvent }) => {
  return (
    <div 
      className="fixed inset-0 pointer-events-none z-10 flex flex-col p-6 font-inter"
      role="status"
      aria-live="polite"
    >
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          <section 
            className="bg-black/60 backdrop-blur-md border-l-4 border-cyan-500 px-4 py-2 rounded-r-lg shadow-[0_0_20px_rgba(6,182,212,0.2)]"
          ...
          <section 
            className="bg-black/60 backdrop-blur-md border-l-4 border-yellow-500 px-4 py-2 rounded-r-lg"
            aria-label="Coin counter"
          >
        ...
        <div className="text-right space-y-2">
          <section 
            className="bg-black/60 backdrop-blur-md border-r-4 border-purple-500 px-6 py-4 rounded-l-lg"
            aria-label="Current score and multiplier"
          >
            <div className="text-[10px] uppercase tracking-[0.2em] text-purple-400 font-bold">Multiplier x{stats.multiplier}</div>
      ...
      <div className="mt-auto flex justify-between items-end">
        <div className="w-64 space-y-4">
          <div className="space-y-1">
            <div className="flex justify-between text-[10px] uppercase tracking-widest font-bold text-cyan-400">
              <label id="bio-sync-label">Bio-Sync Status</label>
            ...
            <div className="h-2 w-full bg-slate-900 rounded-full overflow-hidden border border-slate-800">
              <div 
                ...
                aria-labelledby="bio-sync-label"
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-[10px] uppercase tracking-widest font-bold text-emerald-400">
              <label id="chrono-label">Chrono Capacity</label>
        ...
        {activeEvent && (
          <div 
            className="mb-4 mr-4 animate-bounce"
            role="alert"
          >
            <div className="bg-red-500/20 backdrop-blur-xl border-l-4 border-red-500 p-4 rounded-r-xl max-w-xs shadow-[0_0_30px_rgba(239,68,68,0.3)]">
              ...
              {activeEvent.source && (
                <div className="text-[8px] text-red-400/60 mt-1 uppercase truncate">
                  Feed: {activeEvent.source}
                </div>
              )}
            </div>
          </div>
